                                        ...
                                        <div id="content">
                                            ...
                                            <table width="100%" align="center">
                                                <tr>
                                                    ...
                                                    <td align="center" style="border: 1px solid rgb(153,153,153);"><b>Mobile Number</b></td>
                                                    <td align="center" style="border: 1px solid rgb(153,153,153);"><b>Town</b></td>
                                                    <td align="center" style="border: 1px solid rgb(153,153,153);"><b>Country</b></td>
                                                    <td align="center" style="border: 1px solid rgb(153,153,153);"><b>Emergency Contact Name</b></td>
                                                    <td align="center" style="border: 1px solid rgb(153,153,153);"><b>Emergency Contact Mobile</b></td>
                                                </tr>
                                                ...
                                                if ($query) {
                                                    ...
                                                    while ($row = mysql_fetch_array($query)) {
                                                        $empID =  $row['empID'];
                                                        $innerQuery1 = mysql_query("SELECT * FROM  `employeeemergencycontactinformation` where empID = '$empID'");
                                                            $row1 = "";
                                                            if ($innerQuery1) {
                                                            ...
                                                            $innerQuery2 = mysql_query("SELECT * FROM  `employeecontactinformation` where empID = '$empID'");
                                                            $row2 = "";
                                                            if ($innerQuery2) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center" style="border: 1px solid rgb(153,153,153);"><b style="color: #3399ff;"><?php echo $empID; ?></b></td>
                                                            ...
                                                            <td align="center" style="border: 1px solid rgb(153,153,153);"><?php echo $row2['mobileNumber']; ?></td>
                                                            <td align="center" style="border: 1px solid rgb(153,153,153);"><?php echo $row2['town']; ?></td>
                                                            <td align="center" style="border: 1px solid rgb(153,153,153);"><?php echo $row2['country']; ?></td>
                                                            <td align="center" style="border: 1px solid rgb(153,153,153);"><?php echo $row1['firstName']." ".$row1['lastName']; ?></td>
                                                            <td align="center" style="border: 1px solid rgb(153,153,153);"><?php echo $row1['mobileNumber']; ?></td>
                                                        </tr>
