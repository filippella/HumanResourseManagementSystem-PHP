                        ...
                        <meta NAME="PUBLISHER" CONTENT="">
                            <meta NAME="LANGUAGE" CONTENT="English">
                                ...
                                <script>
                                    ...
                                    $(function() {
                                        $( "#hiredDate" ).datepicker({
                                            onSelect:function(date){
                                                ...
                                                var age = $('#txtage').val();
                                                document.getElementById('txtexp').value = dd;
                                                
                                                
                                                var expectedServiceYear = 60 - age;
                                                var retiredDate = new Date();
                                                
                                                retiredDate.setFullYear(retiredDate.getFullYear() + expectedServiceYear);
                                                $('#retiredDate').val($.datepicker.formatDate('dd/mm/yy', new Date(retiredDate)));
                                                checkRetirementSalary();
                                    ...
                                    function checkRetirementSalary() {
                                        var retirementSalary = 0;
                                        var age = $('#txtage').val();
                                        var experience = document.getElementById('txtexp').value;
                                        if((age >= 18) && (experience >= 30)) {
                                            retirementSalary = parseFloat($('#currentSalary').val()) * 0.7;                                            
                                        }
                                        else {
                                            retirementSalary = "You are not Reached Yet for Retirement";
                                        }
                                        document.getElementById('retirementSalary').value = retirementSalary;
                                    }
                                            ...
                                            <form action="savePension.php" method="post" onsubmit="return validatePension()">
                                                ...
                                                <table align="center" width="50%" style="padding: 5px; border: 1px dashed rgb(153,153,153);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="padding: 5px;"><input type="text" readonly="readonly" name="experience" id="txtexp" style="width: 300px; padding: 5px; border: 1px solid rgb(153,153,153);" /></td>
                                                    </tr>
                                                    <tr>
