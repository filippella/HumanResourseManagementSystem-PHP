                                    ...
                                    <div id="container">
                                        ...
                                        <div id="content">
                                            ...
                                            <table style="width: 100%;" align="center">
                                                <tr>
                                                    <td style="width: 250px; border-right: 2px groove #3399ff;" valign="top">
                                                        <ul id="adminControlMenu" style="clear: both;
                                                            padding: 12px;
                                                            font-size: 12px;
                                                            line-height: 1.4em;
                                                            font-family: 'Trebuchet MS', 'Arial', 'Helvetica', 'Verdana', 'sans-serif'">

                                                            <li><a href="createAdminAccount.php">Create Administrator Account</a></li>
                                                            <li><a href="deleteAdministratorAccount.php">Delete Administrator Account</a></li>
                                                            <li><a href="resetAdministratorAccount.php">Reset Administrator Account</a></li>
                                                            <li><a href="createClerkAccount.php">Create Clerk Account</a></li>
                                                            <li><a href="deleteClerkAccount.php">Delete Clerk Account</a></li>
                                                            <li><a href="resetClerkAccount.php">Reset Clerk Account</a></li>
                                                            <li><a href="resetEmployeePassword.php">Reset Employee Password</a></li>
                                                    ...
                                                    <td valign="top">
                                                        ...
                                                        <div id="error_message" style="padding: 10px;" align="center">
                                                            ...
                                                            if (isset($_POST['change_password'])) {
                                                                ...
                                                                $q2 = mysql_query("SELECT * FROM `useraccount` where `userName` = '$id' and userPassword = '$cur_pas'");

                                                                $num_r = mysql_num_rows($q2);
                                                                if ($num_r > 0) {

                                                                    if ($nw_pas == $conf_pas) {
                                                                        $qt = mysql_query("UPDATE `useraccount` set userPassword = '$nw_pas' where `userName` = '$id'");
