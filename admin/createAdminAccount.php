                                        ...
                                        <div id="content">
                                            ...
                                            <div style="text-align: center;">
                                                ...
                                                if (isset($_POST['createClerk'])) {
                                                    ...
                                                    if ($userPassword != $ccp) {
                                                        ...
                                                        $query = $Db->createAdminAccountInformation($userName, $userPassword, "admin", "enabled");
                                                        if ($query) {
                                                            echo "<b style='color: green;'>Administrator Account has beeen Created Successfully!!!</b>";
                                                        } else {
                                            ...
                                            <form name="" action="" method="post">
                                                <table align="center" width="60%" style="border: 1px solid #000000;">
                                                    <tr>
                                                        <td align="center" colspan="2" style="padding: 15px; background-color: lightcyan;"><h3>Create New Administrator Account</h3></td>
                                                    </tr>
                                                    <tr>
