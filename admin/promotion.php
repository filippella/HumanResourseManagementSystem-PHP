                                ...
                                <body>
                                    ...
                                    <div id="container">
                                        ...
                                        <div id="content">
                                            ...
                                            <h3 align="center"><u>Promotion Management Module</u></h3>
                                            <br />

                                            <form name="" action="savePromotion.php" method="post">
                                                ...
                                                <table align="center" width="50%" style="padding: 5px; border: 1px dashed rgb(153,153,153);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="padding: 5px;"><input type="text" name="currentCarrierStatus" style="width: 300px; padding: 5px; border: 1px solid rgb(153,153,153);" /></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="right" style="padding: 5px; color: #663300;">Process Type: </td>
                                                        <td align="left" style="padding: 5px;">
                                                            <select name="processType" size="1"  style="width: 300px; padding: 5px; border: 1px solid rgb(153,153,153);">
                                                    ...
                                                    <tr>
                                                        <td align="right" style="padding: 5px; color: #663300;">Promoted/Demoted To: </td>
                                                        <td align="left" style="padding: 5px;"><input type="text" name="to" style="width: 300px; padding: 5px; border: 1px solid rgb(153,153,153);" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" style="padding: 5px; color: #663300;" valign="top">Reason: </td>
                                                        <td align="left" style="padding: 5px;">
                                                            <textarea name="reason1" style="width: 300px; height: 100px; overflow: auto; padding: 5px; border: 1px solid rgb(153,153,153);"></textarea></td>
                                                    </tr>
                                                    <tr>
