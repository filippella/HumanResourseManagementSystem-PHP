                                ...
                                <body>
                                    ...
                                    <div id="container">
                                        ...
                                        <div id="content">
                                            ...
                                            <h3 align="center"><u>View Appraisal</u></h3>
                                            <br />
                                            ...
                                            <table align="center" width="99%" style="padding: 5px; border: 1px dashed rgb(153,153,153);">
                                                <tr>
                                                    ...
                                                    <td align="center" style="background-color: #cccccc; padding: 5px; color: #cd0a0a; border: 1px solid rgb(153,153,153);"><b>Academic Year:</b> </td>
                                                    ...
                                                    <td align="center" style="background-color: #cccccc; padding: 5px; color: #cd0a0a; border: 1px solid rgb(153,153,153);"><b>Total Score: </b> </td>
                                                    <td align="center" style="background-color: #cccccc; padding: 5px; color: #cd0a0a; border: 1px solid rgb(153,153,153);"><b>Evaluated By: </b> </td>
                                                    ...
                                                    <td align="center" style="background-color: #cccccc; padding: 5px; color: #cd0a0a; border: 1px solid rgb(153,153,153);"><b>Evaluation Date: </b> </td>
                                                </tr>

                                                <?php
                                                $query = mysql_query("SELECT * FROM  `EmployeeAppraisal`");
                                                if ($query) {
                                                    $i = 0;
                                                    while ($row = mysql_fetch_array($query)) {
                                                        $empID = $row['empID'];

                                                        $rr = mysql_query("SELECT * FROM `employeeemploymentinformation` where empID = '$empID'");
                                                        $rg = "";
                                                        if($rr) {
                                                            $rg = mysql_fetch_array($rr);
                                                        }
                                                        ?>
                                                        <tr>
                                                            <td align="left" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);"><?php echo $empID; ?></td>
                                                            <td align="left" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);"><?php echo $row['academicYear']; ?></td>
                                                            <td align="left" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);"><?php echo $row['staffType']; ?></td>
                                                            <td align="left" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);"><?php echo $row['totalScore']; ?></td>
                                                            <td align="left" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);"><?php echo $row['evaluatedBy']; ?></td>
                                                            <td align="left" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);"><?php echo $rg['department']; ?></td>
