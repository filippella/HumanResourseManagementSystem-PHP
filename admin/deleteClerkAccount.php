                                                    ...
                                                    <td valign="top">
                                                        ...
                                                        <div id="error_message" style="padding: 10px;" align="center">
                                                            ...
                                                            if (isset($_POST['delete'])) {
                                                                ...
                                                                $qt = mysql_query("DELETE FROM `clearkuseraccount` where `userName` = '$user'");
                                                                if ($qt) {
                                                                    echo "<b style='color: green;'>Clerk Account has been deleted Successfully!</b>";
                                                                } else {
                                                        ...
                                                        <div style="width: 500px;   height: auto; padding-top: 10px; padding-bottom: 10px;
                                                            ...
                                                            <p><h3  align="center">Delete Clerk Account</h3></p>
