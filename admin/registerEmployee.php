...
$Db->createEmployeeAccountInformation($employeeId, "12345", "employee", "enabled");
...
$res1 = $Db->saveEmployeeGeneralInfo($employeeId, $employeeFisrtName, $employeeLastName, $gender, $image, $vacCode);
...
$res2 = $Db->saveEmployeeContactInfo($employeeId, $mobileNumber, $telephoneNumber, $country, $town);
echo $res2;
...
$res3 = $Db->saveEmployeeAdrressInfo($employeeId, $email, $region, $subcity, $woreda, $kebele, $houseNumber);
echo $res3;
...
$res4 = $Db->saveEmployeePersonalInfo($employeeId, $dateOfBirth, $maritalStatus, $motherName, $numberOfSon, $numberOfDaughter);
echo $res4;
...
$res5 = $Db->saveEmployeeEmploymentInfo($employeeId, $employmentDate, $employeeJobTitle, $startingSalary, $currentSalary, $pensionIdentityNumber, $tinNumber, $department, $membership, $jobStatus, $status);
echo $res5;
...
$res6 = $Db->saveEmployeeEmergencyContactInfo($employeeId, $em_firstName, $em_lastName, $em_mobileNumber, $em_telNumber, $em_country, $em_region, $em_town, $em_kebele);
echo $res6;

header("location: success.php?msg='Registered to'");
exit;
?>
