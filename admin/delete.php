                                ...
                                <body>
                                    ...
                                    <div id="container">
                                        ...
                                        <div id="content">
                                            ...
                                            <form name="" action="deleteEmployee.php" method="post" enctype="multipart/form-data">

                                                <table align="center" width="70%">
                                                    <tr>
                                                        <td align="right" style="padding: 5px;">Please Specify the Employee Id to delete: </td>
                                                        ...
                                                        <td align="left">
                                                            <input type="submit" value="" style="background: transparent; background-image: url('../css/images/delete.png'); width: 100px; height: 25px; display: inline-block;" />
                                                        </td>
                                                    </tr>
                                                </table>
