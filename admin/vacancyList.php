                                ...
                                <body>
                                    ...
                                    <div id="container">
                                        ...
                                        <div id="content">
                                            ...
                                            <h3 align="center"><u>View Posted Vacancy List</u></h3>
                                            <br />
                                            ...
                                            <form name="" action="" method="post">
                                                ...
                                                <table align="center" width="99%" style="padding: 5px; border: 1px dashed rgb(153,153,153);">
                                                    <tr>
                                                        <td align="center" style="background-color: #cccccc; padding: 5px; color: #cd0a0a; border: 1px solid rgb(153,153,153);"><b>Vacancy Code</b> </td>
                                                        <td align="center" style="background-color: #cccccc; padding: 5px; color: #cd0a0a; border: 1px solid rgb(153,153,153);"><b>Vacancy Name:</b> </td>
                                                        <td align="center" style="background-color: #cccccc; padding: 5px; color: #cd0a0a; border: 1px solid rgb(153,153,153);"><b>Vacancy Detail</b> </td>
                                                        <td align="center" style="background-color: #cccccc; padding: 5px; color: #00F; border: 1px solid rgb(153,153,153);"><b>Date</b> </td>
                                                        <td align="center" style="background-color: #cccccc; padding: 5px; color: #00F; border: 1px solid rgb(153,153,153);"><b>Action</b>
                                                    </tr>
                                                    ...
                                                    if ($query) {
                                                        ...
                                                        while ($row = mysql_fetch_array($query)) {
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td align="left" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);"><?php echo $vacCode; ?></td>
                                                                <td align="left" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);"><?php echo $row['vacName']; ?></td>
                                                                <td align="left" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);"><?php echo $row['detailVacancy']; ?></td>
                                                                <td align="left" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);"><?php echo $row['openDate'] . "-" . $row['closeDate']; ?></td>
                                                                <td align="center" style="padding: 5px; color: #663300; border: 1px solid rgb(153,153,153);">

                                                                        <a href="deleteVacancy.php?vacID=<?php echo $vacCode; ?>" target="_self" style="background-image: url('../css/images/deleteVac.png'); width: 60px; height: 30px; display: inline-block;"></a>
