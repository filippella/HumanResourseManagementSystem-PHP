...
if ($res6 == 1) {
    header("location: success.php?msg2='Employee Information is Successfully Updated to HRMS Database'");
    exit;
} else {
    header("location: failed.php?msg2='Employee Information is Not Successfully Updated to HRMS Database'");
    exit;
}
